  ...
  return (
    <div className="min-h-screen bg-gray-200 pb-10">
      ...
      <div className="bg-gradient-to-b  from-white to-gray-200 ">
        <div className="relative flex justify-center h-[600px] bg-gradient-to-b to-plantGreenDark from-plantGreen max-w-7xl rounded-2xl mx-10 md:mx-auto overflow-hidden">
          ...
          <div className="justify-center mx-auto z-10">
            ...
            <div className="relative flex mx-auto justify-center mt-7 drop-shadow-lg text-plantGreenLight h-72 w-72 md:h-96 md:w-96 text-3xl md:text-4xl leading-8 font-bold tracking-tight  bg-plantGreen border-4 border-plantGreenLight rounded-[50%] overflow-hidden">
              <div className=" bg-[url('../assets/leaves.jpg')] opacity-20 h-full w-full absolute "></div>

              <div className="z-10 pt-32 md:pt-40">
